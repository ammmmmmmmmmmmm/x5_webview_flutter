...
typedef void OverrideKeyEvent(RawKeyEvent event);
  ...
  Future _onMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case "onUrlLoading":
        ...
        break;
      case "shouldOverrideKeyEvent":
        print("on method call shouldOverrideKeyEvent: ${_widget.shouldOverrideKeyEvent != null}");
        if (_widget.shouldOverrideKeyEvent != null) {
          Map args = call.arguments;
          print("invoke method _widget.shouldOverrideKeyEvent: ${args}");
          try {
            _widget.shouldOverrideKeyEvent(RawKeyEvent.fromMessage(Map.from(args)));

          }catch (e) {
             print("shouldOverrideKeyEvent error ${e}");
          }
        }
      break;  
